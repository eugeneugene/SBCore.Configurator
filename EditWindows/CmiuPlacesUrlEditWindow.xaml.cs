...
{
    /// <summary>
    /// Interaction logic for CmiuPlacesUrlEditWindow.xaml
    /// </summary>
    internal partial class CmiuPlacesUrlEditWindow : Window, IDisposable
    {
        private readonly IHostApplicationLifetime _applicationLifetime;

        private readonly DataContext _context;
        private readonly ObservableCollection<CmiuPlacesUrlData> observableCollection;
        ...
        public CmiuPlacesUrlEditWindow(Connection connection, IHostApplicationLifetime applicationLifetime)
        {
            InitializeComponent();
            ...
            CollectionViewSource itemCollectionViewSource = (CollectionViewSource)FindResource("CmiuPlacesUrlDataSource");
            _context.CmiuPlacesUrlDataSet.Load();
            observableCollection = _context.CmiuPlacesUrlDataSet.Local.ToObservableCollection();
        ...
        private void OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                ClickedItem = null;
                if (e.OriginalSource is TextBlock textBlock && textBlock.DataContext is CmiuPlacesUrlData cmiuPlacesUrlData1)
                    ClickedItem = cmiuPlacesUrlData1;
                if (e.OriginalSource is TextBlock textBlock2 && textBlock2.DataContext is Uri uri)
                    ClickedItem = uri;
                if (e.OriginalSource is Border border && border.DataContext is CmiuPlacesUrlData cmiuPlacesUrlData2)
                    ClickedItem = cmiuPlacesUrlData2;
