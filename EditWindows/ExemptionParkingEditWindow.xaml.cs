...
{
    /// <summary>
    /// Interaction logic for ExemptionParkingEditWindow.xaml
    /// </summary>
    internal partial class ExemptionParkingEditWindow : Window, IDisposable
    {
        private readonly IHostApplicationLifetime _applicationLifetime;
        private readonly DataContext _context;
        private readonly ObservableCollection<MetroParkingData> observableCollection;

        private bool _justCreatedNewItem;
        private bool disposed;

        private MetroParkingData ClickedItem { get; set; }

        public int LinesChanged { get; private set; }

        public ExemptionParkingEditWindow(Connection connection, IHostApplicationLifetime applicationLifetime)
        {
            InitializeComponent();
            ...
            CollectionViewSource itemCollectionViewSource = (CollectionViewSource)FindResource("ExemptionParkingDataSource");
            _context.MetroParkingDataSet.Load();
            observableCollection = _context.MetroParkingDataSet.Local.ToObservableCollection();
        ...
        private void OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                ClickedItem = null;
                if (e.OriginalSource is TextBlock textBlock && textBlock.DataContext is MetroParkingData MetroParkingData1)
                    ClickedItem = MetroParkingData1;
                if (e.OriginalSource is Border border && border.DataContext is MetroParkingData MetroParkingData2)
                    ClickedItem = MetroParkingData2;
