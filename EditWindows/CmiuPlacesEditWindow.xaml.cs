...
{
    /// <summary>
    /// Interaction logic for CmiuPlacesEditWindow.xaml
    /// </summary>
    internal partial class CmiuPlacesEditWindow : Window, IDisposable
    {
        private readonly IHostApplicationLifetime _applicationLifetime;

        private readonly DataContext _context;
        private readonly ObservableCollection<CmiuPlacesData> observableCollection;

        private bool _justCreatedNewItem;
        private bool disposed;

        private CmiuPlacesData ClickedItem { get; set; }

        public int LinesChanged { get; private set; }

        public CmiuPlacesEditWindow(Connection connection, IHostApplicationLifetime applicationLifetime)
        {
            InitializeComponent();
            ...
            CollectionViewSource itemCollectionViewSource = (CollectionViewSource)FindResource("CmiuPlacesDataSource");
            _context.CmiuPlacesDataSet.Load();
            observableCollection = _context.CmiuPlacesDataSet.Local.ToObservableCollection();
        ...
        private void OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                ClickedItem = null;
                if (e.OriginalSource is TextBlock textBlock && textBlock.DataContext is CmiuPlacesData cmiuPlacesData1)
                    ClickedItem = cmiuPlacesData1;
                if (e.OriginalSource is Border border && border.DataContext is CmiuPlacesData cmiuPlacesData2)
                    ClickedItem = cmiuPlacesData2;
