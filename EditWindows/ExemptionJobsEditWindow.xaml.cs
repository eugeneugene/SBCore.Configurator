...
{
    /// <summary>
    /// Interaction logic for ExemptionJobsEditWindow.xaml
    /// </summary>
    internal partial class ExemptionJobsEditWindow : Window, IDisposable
    {
        private readonly IHostApplicationLifetime _applicationLifetime;
        private readonly DataContext _context;
        private readonly ObservableCollection<OAJobData> observableCollection;

        private bool _justCreatedNewItem;
        private bool disposed;

        private OAJobData ClickedItem { get; set; }

        public int LinesChanged { get; private set; }

        public ExemptionJobsEditWindow(Connection connection, IHostApplicationLifetime applicationLifetime)
        {
            InitializeComponent();
            ...
            CollectionViewSource itemCollectionViewSource = (CollectionViewSource)FindResource("OAJobDataSource");
            _context.OAJobDataSet.Load();
            observableCollection = _context.OAJobDataSet.Local.ToObservableCollection();
        ...
        private void OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                ClickedItem = null;
                if (e.OriginalSource is TextBlock textBlock && textBlock.DataContext is OAJobData OAJobData1)
                    ClickedItem = OAJobData1;
                if (e.OriginalSource is Border border && border.DataContext is OAJobData OAJobData2)
                    ClickedItem = OAJobData2;
