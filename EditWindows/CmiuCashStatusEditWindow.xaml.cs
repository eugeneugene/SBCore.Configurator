...
namespace SBCore.Configurator.EditWindows
{
    ...
    /// </summary>
    internal partial class CmiuCashStatusEditWindow : Window, IDisposable
    {
        private readonly IHostApplicationLifetime _applicationLifetime;

        private readonly DataContext _context;
        private readonly ObservableCollection<CmiuCashStatusData> observableCollection;

        private bool _justCreatedNewItem;
        private bool disposed;

        private CmiuCashStatusData ClickedItem { get; set; }

        public int LinesChanged { get; private set; }

        public CmiuCashStatusEditWindow(Connection connection,  IHostApplicationLifetime applicationLifetime)
        {
            InitializeComponent();
            ...
            CollectionViewSource itemCollectionViewSource = (CollectionViewSource)FindResource("CmiuCashStatusDataSource");
            _context.CmiuCashStatusDataSet.Load();
            observableCollection = _context.CmiuCashStatusDataSet.Local.ToObservableCollection();
        ...
        private void OnMouseDown(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                ClickedItem = null;
                if (e.OriginalSource is TextBlock textBlock && textBlock.DataContext is CmiuCashStatusData cmiuCashStatusData1)
                    ClickedItem = cmiuCashStatusData1;
                if (e.OriginalSource is Border border && border.DataContext is CmiuCashStatusData cmiuCashStatusData2)
                    ClickedItem = cmiuCashStatusData2;
